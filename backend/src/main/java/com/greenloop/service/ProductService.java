...
public class ProductService {
    ...
    /** Returns a customer-visible product for public QR-code links. */
    ...
    /**
     * Deletes a product only when it belongs to the authenticated farmer.
     */
    @Transactional
    public void deleteProductForFarmer(Long id, Long farmerId) {
        Product product = productRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Product not found"));
    ...
    /**
     * Updates farmer-editable fields while keeping ownership, retailer, pricing,
     * location, and product status under backend control.
     */
    @Transactional
